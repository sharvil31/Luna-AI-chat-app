        ...
        <div className='flex flex-col p-4'>
          ...
          <div className='flex flex-col gap-2 max-w-[480px] w-full mx-auto'>
            ...
            <p className='tracking-[0.5px] leading-6 text-[#3F4945] dark:text-[#BFC9C4] mt-1 mb-5 text-center px-2'>
              Enter your Luna account details to Login
            </p>
            ...
            >
              ...
              <div className="text-right">
                <Link to="/reset-link" className="link text-sm font-medium leading-5 tracking-[0.1px] inline-block">
                Forgot password?
                </Link>
              </div>
            ...
            <p className='text-sm leading-5 tracking-[0.25px] text-light-onSurfaceVariant dark:text-dark-onSurfaceVariant text-center mt-4'>
              Don&apos;t have an account?
              <Link
                to="/register"
                className='link inline-block ms-1 text-light-onSurface dark:text-dark-onSurface text-base leading-5 tracking-[0.25px]'
              >
                Create an account
              </Link>
            </p>
